	...
	<input type="text" class="form-control" id="txtBuscar" placeholder="Buscar" />               
								...
								<div id="container">
									<div class="speaker_item">
										...
										<h4 class="speaker_item_name color-naranja-suave" onclick="abrirDetalle(0);">Alejandro<br>Durán</h4>
									...
									<div class="speaker_item">
										<div class="speaker_item_boxphoto"><img src="https://networking.barter.es/gestor/upload/380/fake.jpg" class="img-fluid speaker_item_photo"></div>
										<h4 class="speaker_item_name color-naranja-suave" onclick="abrirDetalle(2);">Alondra<br>Faustro</h4>
										<div class="speaker_item_contenido">
											<!-- <p class="speaker_item_company"> </p> -->
										</div>
									</div>
									...
									<div class="speaker_item">
										<div class="speaker_item_boxphoto"><img src="https://networking.barter.es/gestor/upload/380/fake.jpg" class="img-fluid speaker_item_photo"></div>
										<h4 class="speaker_item_name color-naranja-suave" onclick="abrirDetalle(12);">Julieta<br>Martínez</h4>
										<div class="speaker_item_contenido">
											<!-- <p class="speaker_item_company"> </p> -->
										</div>
									</div>
									...
									<div class="speaker_item">
										<div class="speaker_item_boxphoto"><img src="https://networking.barter.es/gestor/upload/380/fake.jpg" class="img-fluid speaker_item_photo"></div>
										<h4 class="speaker_item_name color-naranja-suave" onclick="abrirDetalle(15);">Sofía<br>Castillo</h4>
										<div class="speaker_item_contenido">
											<!-- <p class="speaker_item_company"> </p> -->
										</div>
									</div>
					...
					<div class="session_item_row">
						  <div class="session_item_contenido unico">
			  <div>
          		  <h5 class="session_item_title mt-2 fw-semibold">Betto Arcos "Del Barrio del Dique al Barrio Cósmico"</h5>
				        <p><i class="bi bi-clock"></i>&nbsp;4 de may de 2024 12:30 a 13:30</p>
                <p class="session_item_room"><i class="bi bi-geo-alt"></i>&nbsp;Teatro Complejo Cultural Universitario</p>
              </div>     		  
          </div>
					  </div>
         		</div> -->
                  ...
                  <p class="session_item_room"><i class="bi bi-geo-alt"></i>&nbsp;Escenario en T</p>
										...
										<div class="sesion9 row d-none">
											...
											<div class="col-12">
												...
												<div class="speaker_detail_contenido">
													<p class="speaker_detail_jobposition text-center">Global Smart Cities Expert Group & Neurabitat Corp.</p>
												</div>
											</div>
											<!-- <div class="col-12 speaker_detail_sessions">
					<h4 class="mt-0 pt-5 pb-0 fw-semibold" style="border-top: 1px solid #444;">
					...
					<div class="session_item_row">
						 <div class="session_item_contenido unico">
				  <div>
          		  <h5 class="session_item_title mt-2 fw-semibold">Sara Pineda “NatGeo en Primera Persona: Historias de una Exploradora</h5>
				  <p><i class="bi bi-clock"></i>&nbsp;4 de may de 2024 16:00 a 17:00</p>
                  <p class="session_item_room"><i class="bi bi-geo-alt"></i>&nbsp;Teatro Complejo Cultural Universitario</p>
              </div>     		  
          </div>
					  </div>
							...
							<div>
								...
								<p class="session_item_room"><i class="bi bi-geo-alt"></i>&nbsp;Grand Forum</p>
										...
										<div class="sesion15 row d-none">
											...
											<div class="col-12">
												<h3 class="speaker_detail_nombre">Sofía Castillo</h3>
												<div class="speaker_detail_contenido">
													<!-- <p class="speaker_detail_jobposition text-center"> </p> -->
												</div>
											</div>
